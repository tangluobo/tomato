...
public class CRC {
    public static enum Type {
        ...
        private int initial;
        private Type(int s, int i) { numbytes = s; initial = i; }
    ...
    private static final int cr3tab[] = {
    ...
    public CRC(Type t) { type = t; crc = type.initial(); }

    public void update(byte b) {
        switch (type) {
            case CRC16: crc = updcrc(0xff & b, crc); break;
            case CRC32: crc = updcrc32((0xff & b), crc); break;
        }
    }

    public void update(byte[] array) { for (byte b : array) update(b); }

    public void finalized() {
        switch (type) {
            case CRC16: crc = 0xffff & updcrc(0, updcrc(0, crc)); break;
            case CRC32: crc = ~crc; break;
        }
    }
